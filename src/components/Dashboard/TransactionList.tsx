...
import { Edit, Trash2, CheckCircle, HourglassIcon, HelpCircle } from 'lucide-react';
              ...
              {transactions.map((transaction) => {
                ...
                return (
                  <tr key={`${transaction.id}-${transaction.timestamp}`} className="hover:bg-gray-50">
                    ...
                    <td className="hidden md:table-cell px-3 py-4 text-sm text-gray-500 max-w-xs truncate">
